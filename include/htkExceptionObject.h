 ...
 *=========================================================================*/
#ifndef __htkMacro_h
#error "Do not include htkExceptionObject.h directly,  include htkMacro.h instead."
#else // __htkMacro.h

#ifndef __htkExceptionObject_h
#define __htkExceptionObject_h
 ...
 * and managing exceptions in htk. Specific exceptions should be
 * derived from this class. Note that this class is derived from
 * std::exception, so an application can catch htk exceptions as
 ...
 * htkExceptionMacro (found in Common/htkMacro.h) can be used.
 *
 * \ingroup HTKSystemObjects
 * \ingroup HTKCommon
 */
