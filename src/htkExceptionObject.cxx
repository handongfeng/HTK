 ...
 * \brief Exception data, used to implement htk::ExceptionObject.
 *
 * Contains the location and description of the error, as well as
 * the text that should be returned by htk::ExceptionObject::what().
 */
 ...
 * \brief Reference counted exception data, used to implement htk::ExceptionObject.
 *
 * Its first base class, ExceptionObject::ExceptionData, holds its data, while its second
 * base class, htk::LightObject, takes care of the reference counting.
 *
 ...
 * of LightObject.
 */
class ExceptionObject::ReferenceCountedExceptionData:public ExceptionData, public Object
{
public:
...
::Print(std::ostream & os) const
{
  ...
  // Print header
  os << std::endl;
  os << indent << "htk::" << this->GetNameOfClass() << " (" << this << ")\n";
